...
<br><br>
					...
					<a class="btn btn-sm btn-success" href="view.php">EMPLOYEE</a>
				    <a class="btn btn-sm btn-success" href="cusview.php">CUSTOMER</a>
					<a class="btn btn-sm btn-success" href="proview.php">PRODUCT</a>
